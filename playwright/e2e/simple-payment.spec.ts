...
// NOTE: When running in parallel local amplify mock fails to handle multiple parallel requests
...
test.describe('Simple payment', () => {
  test.describe('User has required permissions', () => {
    ...
    test('Should successfully create a simple payment (Reputation decision method)', async () => {
      const recipientAddress = '0x27fF0C145E191C22C75cD123C679C3e1F58a4469';
      ...
      // Created In value is the same as the team name by default
      await expect(
      ...
      await simplePayment.supportPayment();
