...
const meta: Meta<typeof PaginatedTable<TestTableFieldModel>> = {
  title: 'Common/PaginatedTable',
...
export const Base: StoryObj<typeof PaginatedTable<TestTableFieldModel>> = {
  args: {
    pagination: {
      visible: true,
    },
...
export const WithPaginatedContent: StoryObj<
  typeof PaginatedTable<TestTableFieldModel>
> = {
  args: {
    pagination: {
      visible: true,
...
export const WithMenu: StoryObj<typeof PaginatedTable<TestTableFieldModel>> = {
  args: {
    ...Base.args,
    columns: [
      ...(meta.args?.columns ?? []),
