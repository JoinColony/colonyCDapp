...
export type RawStakes = {
  __typename?: 'RawStakes';
  raw: MotionStakeFragment;
};

export type RawStakesInput = {
  raw: MotionStakeFragmentInput;
};
