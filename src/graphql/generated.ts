...
export type CreateProfileInput = {
  advancedSettings?: InputMaybe<ProfileAdvancedSettingsInput>;
  avatar?: InputMaybe<Scalars['String']>;
...
export type Profile = {
  __typename?: 'Profile';
  advancedSettings?: Maybe<ProfileAdvancedSettings>;
...
export type ProfileAdvancedSettings = {
  __typename?: 'ProfileAdvancedSettings';
  customRpc: Scalars['String'];
  decentralizedModeEnabled: Scalars['Boolean'];
  metatransactionsEnabled: Scalars['Boolean'];
};

export type ProfileAdvancedSettingsInput = {
