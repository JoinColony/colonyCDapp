...
export type Query = {
  ...
  bridgeXYZQuery?: Maybe<Scalars['String']>;
...
export type BridgeXyzQueryVariables = Exact<{
  input: BridgeXyzQueryInput;
}>;


export type BridgeXyzQuery = { __typename?: 'Query', bridgeXYZQuery?: string | null };
...
export const BridgeXyzDocument = gql`
    query BridgeXYZ($input: BridgeXYZQueryInput!) {
  bridgeXYZQuery(input: $input)
}
    `;

/**
 * __useBridgeXyzQuery__
 *
 * To run a query within a React component, call `useBridgeXyzQuery` and pass it any options that fit your needs.
 * When your component renders, `useBridgeXyzQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBridgeXyzQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useBridgeXyzQuery(baseOptions: Apollo.QueryHookOptions<BridgeXyzQuery, BridgeXyzQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BridgeXyzQuery, BridgeXyzQueryVariables>(BridgeXyzDocument, options);
      }
export function useBridgeXyzLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BridgeXyzQuery, BridgeXyzQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BridgeXyzQuery, BridgeXyzQueryVariables>(BridgeXyzDocument, options);
        }
export type BridgeXyzQueryHookResult = ReturnType<typeof useBridgeXyzQuery>;
export type BridgeXyzLazyQueryHookResult = ReturnType<typeof useBridgeXyzLazyQuery>;
export type BridgeXyzQueryResult = Apollo.QueryResult<BridgeXyzQuery, BridgeXyzQueryVariables>;
