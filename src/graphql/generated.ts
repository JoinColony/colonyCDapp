...
export type GetMotionsByActionTypeQueryVariables = Exact<{
  actionType: ColonyActionType;
}>;


export type GetMotionsByActionTypeQuery = { __typename?: 'Query', getColonyActionsByType?: { __typename?: 'ModelColonyActionConnection', items: Array<{ __typename?: 'ColonyAction', motionData?: { __typename?: 'ColonyMotion', transactionHash: string, nativeMotionId: string } | null } | null> } | null };
...
export const StreamingPaymentMetadataFragmentDoc = gql`
...
export const GetMotionsByActionTypeDocument = gql`
    query GetMotionsByActionType($actionType: ColonyActionType!) {
  getColonyActionsByType(type: $actionType) {
    items {
      motionData {
        transactionHash
        nativeMotionId
...
/**
 * __useGetMotionsByActionTypeQuery__
 *
 * To run a query within a React component, call `useGetMotionsByActionTypeQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMotionsByActionTypeQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMotionsByActionTypeQuery({
 *   variables: {
 *      actionType: // value for 'actionType'
 *   },
 * });
 */
export function useGetMotionsByActionTypeQuery(baseOptions: Apollo.QueryHookOptions<GetMotionsByActionTypeQuery, GetMotionsByActionTypeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMotionsByActionTypeQuery, GetMotionsByActionTypeQueryVariables>(GetMotionsByActionTypeDocument, options);
      }
export function useGetMotionsByActionTypeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMotionsByActionTypeQuery, GetMotionsByActionTypeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMotionsByActionTypeQuery, GetMotionsByActionTypeQueryVariables>(GetMotionsByActionTypeDocument, options);
        }
export type GetMotionsByActionTypeQueryHookResult = ReturnType<typeof useGetMotionsByActionTypeQuery>;
export type GetMotionsByActionTypeLazyQueryHookResult = ReturnType<typeof useGetMotionsByActionTypeLazyQuery>;
export type GetMotionsByActionTypeQueryResult = Apollo.QueryResult<GetMotionsByActionTypeQuery, GetMotionsByActionTypeQueryVariables>;
