...
export type ColonyContributor = {
  ...
  /** Contributor notification settings */
  notificationSettings?: Maybe<ContributorNotificationSettings>;
...
/** Contributor Notification Settings */
export type ContributorNotificationSettings = {
  __typename?: 'ContributorNotificationSettings';
  /** Whether the user will receive notifications about actions */
  enableActions?: Maybe<Scalars['Boolean']>;
  /** Whether the user will receive notifications about decisions */
  enableDecisions?: Maybe<Scalars['Boolean']>;
  /** Whether the user will receive email notifications */
  enableEmail?: Maybe<Scalars['Boolean']>;
  /** Whether the user will receive push notifications */
  enablePush?: Maybe<Scalars['Boolean']>;
};

export type ContributorNotificationSettingsInput = {
  enableActions?: InputMaybe<Scalars['Boolean']>;
  enableDecisions?: InputMaybe<Scalars['Boolean']>;
  enableEmail?: InputMaybe<Scalars['Boolean']>;
...
export type CreateColonyContributorInput = {
  ...
  notificationSettings?: InputMaybe<ContributorNotificationSettingsInput>;
...
export type CreateNotificationInput = {
  ...
  profileNotificationsId?: InputMaybe<Scalars['ID']>;
...
export type ModelSubscriptionNotificationFilterInput = {
  ...
  colonyId?: InputMaybe<ModelSubscriptionIdInput>;
  createdAt?: InputMaybe<ModelSubscriptionStringInput>;
  links?: InputMaybe<ModelSubscriptionStringInput>;
...
export type Mutation = {
  ...
  /** Send a notification to a user, this also creates a notification in the database */
  ...
  /** Subscribe a user to all Colony Notifications */
  subscribeToColonyPushNotifications?: Maybe<Scalars['Boolean']>;
...
/** Root mutation type */
export type MutationSubscribeToColonyPushNotificationsArgs = {
...
export type Notification = {
  ...
  profileNotificationsId?: Maybe<Scalars['ID']>;
...
export type NotificationSettings = {
   ...
   */
  notificationTokens?: Maybe<Array<Maybe<Scalars['String']>>>;
};

export type NotificationSettingsInput = {
  enableAssign?: InputMaybe<Scalars['Boolean']>;
  enableEmail?: InputMaybe<Scalars['Boolean']>;
  enableMention?: InputMaybe<Scalars['Boolean']>;
  notificationTokens?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
};

/** The different types of notifications a user receives */
...
export type Query = {
  ...
  notificationsByDate?: Maybe<ModelNotificationConnection>;
};
...
/** Root query type */
export type QueryNotificationsByDateArgs = {
  createdAt?: InputMaybe<ModelStringKeyConditionInput>;
  filter?: InputMaybe<ModelNotificationFilterInput>;
  limit?: InputMaybe<Scalars['Int']>;
  nextToken?: InputMaybe<Scalars['String']>;
...
export type SendNotificationInput = {
  /** Unique identifier for Colony action associated with notification */
  associatedActionId?: InputMaybe<Scalars['ID']>;
  /** Unique identifier for user associated with notification */
  associatedUserId: Scalars['ID'];
  /** Unique identifier for Colony notification is sent from */
  colonyId: Scalars['ID'];
  /** Content of notification if a custom notification */
  customNotificationText?: InputMaybe<Scalars['String']>;
  /**
   * Custom title of notification this is usually the colonyName the notification originates from
   * Takes precedence if sent
   */
  customNotificationTitle?: InputMaybe<Scalars['String']>;
  /** Type of notification */
  type: NotificationType;
  /**
   * Unique identifier for the user to send to.
   * If null a notification will be sent to anyone subscribed to the colony notifications
   */
...
/** Input type for subscribing to a Colony Push Notifications */
export type SubscribeColonyPushNotificationInput = {
  /** Unique identifier for Colony where notifications originate */
  colonyId: Scalars['ID'];
  /**
   * Bool indicating whether the user is subscribing or unsubscribing to a Colony's push Notifications
   * True to subscribe, false to unsubscribe
   */
  enable: Scalars['Boolean'];
  /** Unique identifier for the user who wants to subscribe */
  userId: Scalars['ID'];
};
...
export type ColonyMotionFragment = { __typename?: 'ColonyMotion', remainingStakes: Array<string>, userMinStake: string, requiredStake: string, rootHash: string, nativeMotionDomainId: string, isFinalized: boolean, skillRep: string, repSubmitted: string, hasObjection: boolean, isDecision: boolean, gasEstimate: string, transactionHash: string, databaseMotionId: string, motionId: string, motionStakes: { __typename?: 'MotionStakes', raw: { __typename?: 'MotionStakeValues', yay: string, nay: string }, percentage: { __typename?: 'MotionStakeValues', yay: string, nay: string } }, usersStakes: Array<{ __typename?: 'UserStakes', address: string, stakes: { __typename?: 'MotionStakes', raw: { __typename?: 'MotionStakeValues', yay: string, nay: string }, percentage: { __typename?: 'MotionStakeValues', yay: string, nay: string } } }>, motionDomain: { __typename?: 'Domain', id: string, nativeId: number, isRoot: boolean, nativeFundingPotId: number, nativeSkillId: number, reputation?: string | null, reputationPercentage?: string | null, metadata?: { __typename?: 'DomainMetadata', name: string, color: DomainColor, description: string, changelog?: Array<{ __typename?: 'DomainMetadataChangelog', transactionHash: string, oldName: string, newName: string, oldColor: DomainColor, newColor: DomainColor, oldDescription: string, newDescription: string }> | null } | null }, stakerRewards: Array<{ __typename?: 'StakerRewards', address: string, isClaimed: boolean, rewards: { __typename?: 'MotionStakeValues', yay: string, nay: string } }>, voterRecord: Array<{ __typename?: 'VoterRecord', address: string, voteCount: string, vote?: number | null }>, revealedVotes: { __typename?: 'MotionStakes', raw: { __typename?: 'MotionStakeValues', yay: string, nay: string }, percentage: { __typename?: 'MotionStakeValues', yay: string, nay: string } }, motionStateHistory: { __typename?: 'MotionStateHistory', hasVoted: boolean, hasPassed: boolean, hasFailed: boolean, hasFailedNotFinalizable: boolean, inRevealPhase: boolean }, messages?: { __typename?: 'ModelMotionMessageConnection', items: Array<{ __typename?: 'MotionMessage', initiatorAddress: string, name: string, messageKey: string, vote?: string | null, amount?: string | null, initiatorUser?: { __typename?: 'User', walletAddress: string, profile?: { __typename?: 'Profile', avatar?: string | null, bio?: string | null, displayName?: string | null, displayNameChanged?: string | null, email?: string | null, location?: string | null, thumbnail?: string | null, website?: string | null, meta?: { __typename?: 'ProfileMetadata', emailPermissions: Array<string>, metatransactionsEnabled?: boolean | null, decentralizedModeEnabled?: boolean | null, customRpc?: string | null } | null, notificationSettings?: { __typename?: 'NotificationSettings', notificationTokens?: Array<string | null> | null, enableEmail?: boolean | null, enableMention?: boolean | null, enableAssign?: boolean | null } | null } | null, watchlist?: { __typename?: 'ModelWatchedColoniesConnection', items: Array<{ __typename?: 'WatchedColonies', id: string, createdAt: string, colony: { __typename?: 'Colony', name: string, colonyAddress: string, chainMetadata: { __typename?: 'ChainMetadata', chainId: number }, metadata?: { __typename?: 'ColonyMetadata', displayName: string, avatar?: string | null, description?: string | null, thumbnail?: string | null, isWhitelistActivated?: boolean | null, whitelistedAddresses?: Array<string> | null, externalLinks?: Array<{ __typename?: 'ExternalLink', name: ExternalLinks, link: string }> | null, changelog?: Array<{ __typename?: 'ColonyMetadataChangelog', transactionHash: string, newDisplayName: string, oldDisplayName: string, hasAvatarChanged: boolean, hasWhitelistChanged: boolean, haveTokensChanged: boolean, hasDescriptionChanged?: boolean | null, haveExternalLinksChanged?: boolean | null }> | null } | null } } | null> } | null } | null } | null> } | null, objectionAnnotation?: { __typename?: 'Annotation', createdAt: string, message: string } | null, action?: { __typename?: 'ColonyAction', type: ColonyActionType } | null };
...
export type NotificationFragment = { __typename?: 'Notification', createdAt: string, read: boolean, title?: string | null, text: string, links?: Array<string | null> | null, colony: { __typename?: 'Colony', id: string, name: string, metadata?: { __typename?: 'ColonyMetadata', displayName: string } | null } };
...
export type UpdateUserProfileMutation = { __typename?: 'Mutation', updateProfile?: { __typename?: 'Profile', id: string, avatar?: string | null, bio?: string | null, displayName?: string | null, location?: string | null, website?: string | null, email?: string | null, notificationSettings?: { __typename?: 'NotificationSettings', notificationTokens?: Array<string | null> | null, enableEmail?: boolean | null, enableMention?: boolean | null, enableAssign?: boolean | null } | null } | null };
...
export type SubscribeToColonyPushNotificationsMutationVariables = Exact<{
  input: SubscribeColonyPushNotificationInput;
}>;


export type SubscribeToColonyPushNotificationsMutation = { __typename?: 'Mutation', subscribeToColonyPushNotifications?: boolean | null };

export type UpdateUserNotificationTokenMutationVariables = Exact<{
  id: Scalars['ID'];
  notificationTokens: Array<InputMaybe<Scalars['String']>> | InputMaybe<Scalars['String']>;
}>;


export type UpdateUserNotificationTokenMutation = { __typename?: 'Mutation', updateProfile?: { __typename?: 'Profile', id: string, notificationSettings?: { __typename?: 'NotificationSettings', notificationTokens?: Array<string | null> | null } | null } | null };
...
export type GetColonyMotionQuery = { __typename?: 'Query', getColonyMotion?: { __typename?: 'ColonyMotion', remainingStakes: Array<string>, userMinStake: string, requiredStake: string, rootHash: string, nativeMotionDomainId: string, isFinalized: boolean, skillRep: string, repSubmitted: string, hasObjection: boolean, isDecision: boolean, gasEstimate: string, transactionHash: string, databaseMotionId: string, motionId: string, motionStakes: { __typename?: 'MotionStakes', raw: { __typename?: 'MotionStakeValues', yay: string, nay: string }, percentage: { __typename?: 'MotionStakeValues', yay: string, nay: string } }, usersStakes: Array<{ __typename?: 'UserStakes', address: string, stakes: { __typename?: 'MotionStakes', raw: { __typename?: 'MotionStakeValues', yay: string, nay: string }, percentage: { __typename?: 'MotionStakeValues', yay: string, nay: string } } }>, motionDomain: { __typename?: 'Domain', id: string, nativeId: number, isRoot: boolean, nativeFundingPotId: number, nativeSkillId: number, reputation?: string | null, reputationPercentage?: string | null, metadata?: { __typename?: 'DomainMetadata', name: string, color: DomainColor, description: string, changelog?: Array<{ __typename?: 'DomainMetadataChangelog', transactionHash: string, oldName: string, newName: string, oldColor: DomainColor, newColor: DomainColor, oldDescription: string, newDescription: string }> | null } | null }, stakerRewards: Array<{ __typename?: 'StakerRewards', address: string, isClaimed: boolean, rewards: { __typename?: 'MotionStakeValues', yay: string, nay: string } }>, voterRecord: Array<{ __typename?: 'VoterRecord', address: string, voteCount: string, vote?: number | null }>, revealedVotes: { __typename?: 'MotionStakes', raw: { __typename?: 'MotionStakeValues', yay: string, nay: string }, percentage: { __typename?: 'MotionStakeValues', yay: string, nay: string } }, motionStateHistory: { __typename?: 'MotionStateHistory', hasVoted: boolean, hasPassed: boolean, hasFailed: boolean, hasFailedNotFinalizable: boolean, inRevealPhase: boolean }, messages?: { __typename?: 'ModelMotionMessageConnection', items: Array<{ __typename?: 'MotionMessage', initiatorAddress: string, name: string, messageKey: string, vote?: string | null, amount?: string | null, initiatorUser?: { __typename?: 'User', walletAddress: string, profile?: { __typename?: 'Profile', avatar?: string | null, bio?: string | null, displayName?: string | null, displayNameChanged?: string | null, email?: string | null, location?: string | null, thumbnail?: string | null, website?: string | null, meta?: { __typename?: 'ProfileMetadata', emailPermissions: Array<string>, metatransactionsEnabled?: boolean | null, decentralizedModeEnabled?: boolean | null, customRpc?: string | null } | null, notificationSettings?: { __typename?: 'NotificationSettings', notificationTokens?: Array<string | null> | null, enableEmail?: boolean | null, enableMention?: boolean | null, enableAssign?: boolean | null } | null } | null, watchlist?: { __typename?: 'ModelWatchedColoniesConnection', items: Array<{ __typename?: 'WatchedColonies', id: string, createdAt: string, colony: { __typename?: 'Colony', name: string, colonyAddress: string, chainMetadata: { __typename?: 'ChainMetadata', chainId: number }, metadata?: { __typename?: 'ColonyMetadata', displayName: string, avatar?: string | null, description?: string | null, thumbnail?: string | null, isWhitelistActivated?: boolean | null, whitelistedAddresses?: Array<string> | null, externalLinks?: Array<{ __typename?: 'ExternalLink', name: ExternalLinks, link: string }> | null, changelog?: Array<{ __typename?: 'ColonyMetadataChangelog', transactionHash: string, newDisplayName: string, oldDisplayName: string, hasAvatarChanged: boolean, hasWhitelistChanged: boolean, haveTokensChanged: boolean, hasDescriptionChanged?: boolean | null, haveExternalLinksChanged?: boolean | null }> | null } | null } } | null> } | null } | null } | null> } | null, objectionAnnotation?: { __typename?: 'Annotation', createdAt: string, message: string } | null, action?: { __typename?: 'ColonyAction', type: ColonyActionType } | null } | null };
...
export type GetFullColonyByAddressQuery = { __typename?: 'Query', getColonyByAddress?: { __typename?: 'ModelColonyConnection', items: Array<{ __typename?: 'Colony', name: string, version: number, reputation?: string | null, expendituresGlobalClaimDelay?: number | null, colonyAddress: string, nativeToken: { __typename?: 'Token', decimals: number, name: string, symbol: string, type?: TokenType | null, avatar?: string | null, thumbnail?: string | null, tokenAddress: string }, status?: { __typename?: 'ColonyStatus', recovery?: boolean | null, nativeToken?: { __typename?: 'NativeTokenStatus', mintable?: boolean | null, unlockable?: boolean | null, unlocked?: boolean | null } | null } | null, chainMetadata: { __typename?: 'ChainMetadata', chainId: number }, tokens?: { __typename?: 'ModelColonyTokensConnection', items: Array<{ __typename?: 'ColonyTokens', colonyTokensId: string, token: { __typename?: 'Token', decimals: number, name: string, symbol: string, type?: TokenType | null, avatar?: string | null, thumbnail?: string | null, tokenAddress: string } } | null> } | null, motionsWithUnclaimedStakes?: Array<{ __typename?: 'ColonyUnclaimedStake', motionId: string, unclaimedRewards: Array<{ __typename?: 'StakerRewards', address: string, rewards: { __typename?: 'MotionStakeValues', nay: string, yay: string } }> }> | null, domains?: { __typename?: 'ModelDomainConnection', items: Array<{ __typename?: 'Domain', id: string, nativeId: number, isRoot: boolean, nativeFundingPotId: number, nativeSkillId: number, reputation?: string | null, reputationPercentage?: string | null, metadata?: { __typename?: 'DomainMetadata', name: string, color: DomainColor, description: string, changelog?: Array<{ __typename?: 'DomainMetadataChangelog', transactionHash: string, oldName: string, newName: string, oldColor: DomainColor, newColor: DomainColor, oldDescription: string, newDescription: string }> | null } | null } | null> } | null, balances?: { __typename?: 'ColonyBalances', items?: Array<{ __typename?: 'ColonyBalance', id: string, balance: string, domain?: { __typename?: 'Domain', id: string, nativeId: number, isRoot: boolean, nativeFundingPotId: number, nativeSkillId: number, reputation?: string | null, reputationPercentage?: string | null, metadata?: { __typename?: 'DomainMetadata', name: string, color: DomainColor, description: string, changelog?: Array<{ __typename?: 'DomainMetadataChangelog', transactionHash: string, oldName: string, newName: string, oldColor: DomainColor, newColor: DomainColor, oldDescription: string, newDescription: string }> | null } | null } | null, token: { __typename?: 'Token', decimals: number, name: string, symbol: string, type?: TokenType | null, avatar?: string | null, thumbnail?: string | null, tokenAddress: string } } | null> | null } | null, fundsClaims?: { __typename?: 'ModelColonyFundsClaimConnection', items: Array<{ __typename?: 'ColonyFundsClaim', id: string, createdAtBlock: number, createdAt: string, amount: string, token: { __typename?: 'Token', decimals: number, name: string, symbol: string, type?: TokenType | null, avatar?: string | null, thumbnail?: string | null, tokenAddress: string } } | null> } | null, chainFundsClaim?: { __typename?: 'ColonyChainFundsClaim', id: string, createdAtBlock: number, createdAt: string, amount: string } | null, metadata?: { __typename?: 'ColonyMetadata', displayName: string, avatar?: string | null, description?: string | null, thumbnail?: string | null, isWhitelistActivated?: boolean | null, whitelistedAddresses?: Array<string> | null, externalLinks?: Array<{ __typename?: 'ExternalLink', name: ExternalLinks, link: string }> | null, changelog?: Array<{ __typename?: 'ColonyMetadataChangelog', transactionHash: string, newDisplayName: string, oldDisplayName: string, hasAvatarChanged: boolean, hasWhitelistChanged: boolean, haveTokensChanged: boolean, hasDescriptionChanged?: boolean | null, haveExternalLinksChanged?: boolean | null }> | null } | null, roles?: { __typename?: 'ModelColonyRoleConnection', items: Array<{ __typename?: 'ColonyRole', id: string, targetAddress: string, role_0?: boolean | null, role_1?: boolean | null, role_2?: boolean | null, role_3?: boolean | null, role_5?: boolean | null, role_6?: boolean | null, domain: { __typename?: 'Domain', id: string, nativeId: number } } | null> } | null } | null> } | null };
...
export type CombinedUserQuery = { __typename?: 'Query', getUserByAddress?: { __typename?: 'ModelUserConnection', items: Array<{ __typename?: 'User', walletAddress: string, profile?: { __typename?: 'Profile', avatar?: string | null, bio?: string | null, displayName?: string | null, displayNameChanged?: string | null, email?: string | null, location?: string | null, thumbnail?: string | null, website?: string | null, meta?: { __typename?: 'ProfileMetadata', emailPermissions: Array<string>, metatransactionsEnabled?: boolean | null, decentralizedModeEnabled?: boolean | null, customRpc?: string | null } | null, notificationSettings?: { __typename?: 'NotificationSettings', notificationTokens?: Array<string | null> | null, enableEmail?: boolean | null, enableMention?: boolean | null, enableAssign?: boolean | null } | null } | null, watchlist?: { __typename?: 'ModelWatchedColoniesConnection', items: Array<{ __typename?: 'WatchedColonies', id: string, createdAt: string, colony: { __typename?: 'Colony', name: string, colonyAddress: string, chainMetadata: { __typename?: 'ChainMetadata', chainId: number }, metadata?: { __typename?: 'ColonyMetadata', displayName: string, avatar?: string | null, description?: string | null, thumbnail?: string | null, isWhitelistActivated?: boolean | null, whitelistedAddresses?: Array<string> | null, externalLinks?: Array<{ __typename?: 'ExternalLink', name: ExternalLinks, link: string }> | null, changelog?: Array<{ __typename?: 'ColonyMetadataChangelog', transactionHash: string, newDisplayName: string, oldDisplayName: string, hasAvatarChanged: boolean, hasWhitelistChanged: boolean, haveTokensChanged: boolean, hasDescriptionChanged?: boolean | null, haveExternalLinksChanged?: boolean | null }> | null } | null } } | null> } | null } | null> } | null, getProfileByUsername?: { __typename?: 'ModelProfileConnection', items: Array<{ __typename?: 'Profile', user: { __typename?: 'User', walletAddress: string, profile?: { __typename?: 'Profile', avatar?: string | null, bio?: string | null, displayName?: string | null, displayNameChanged?: string | null, email?: string | null, location?: string | null, thumbnail?: string | null, website?: string | null, meta?: { __typename?: 'ProfileMetadata', emailPermissions: Array<string>, metatransactionsEnabled?: boolean | null, decentralizedModeEnabled?: boolean | null, customRpc?: string | null } | null, notificationSettings?: { __typename?: 'NotificationSettings', notificationTokens?: Array<string | null> | null, enableEmail?: boolean | null, enableMention?: boolean | null, enableAssign?: boolean | null } | null } | null, watchlist?: { __typename?: 'ModelWatchedColoniesConnection', items: Array<{ __typename?: 'WatchedColonies', id: string, createdAt: string, colony: { __typename?: 'Colony', name: string, colonyAddress: string, chainMetadata: { __typename?: 'ChainMetadata', chainId: number }, metadata?: { __typename?: 'ColonyMetadata', displayName: string, avatar?: string | null, description?: string | null, thumbnail?: string | null, isWhitelistActivated?: boolean | null, whitelistedAddresses?: Array<string> | null, externalLinks?: Array<{ __typename?: 'ExternalLink', name: ExternalLinks, link: string }> | null, changelog?: Array<{ __typename?: 'ColonyMetadataChangelog', transactionHash: string, newDisplayName: string, oldDisplayName: string, hasAvatarChanged: boolean, hasWhitelistChanged: boolean, haveTokensChanged: boolean, hasDescriptionChanged?: boolean | null, haveExternalLinksChanged?: boolean | null }> | null } | null } } | null> } | null } } | null> } | null };
...
export type GetUserNotificationsQuery = { __typename?: 'Query', notificationsByDate?: { __typename?: 'ModelNotificationConnection', items: Array<{ __typename?: 'Notification', createdAt: string, read: boolean, title?: string | null, text: string, links?: Array<string | null> | null, colony: { __typename?: 'Colony', id: string, name: string, metadata?: { __typename?: 'ColonyMetadata', displayName: string } | null } } | null> } | null };
...
export const GetProfile_StcpnDocument = gql`
    query GetProfile_Stcpn($id: ID!) {
  getProfile(id: $id) {
    notificationSettings {
      notificationTokens
    }
...
/**
 * __useGetProfile_StcpnQuery__
 *
 * To run a query within a React component, call `useGetProfile_StcpnQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProfile_StcpnQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProfile_StcpnQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetProfile_StcpnQuery(baseOptions: Apollo.QueryHookOptions<GetProfile_StcpnQuery, GetProfile_StcpnQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProfile_StcpnQuery, GetProfile_StcpnQueryVariables>(GetProfile_StcpnDocument, options);
      }
export function useGetProfile_StcpnLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProfile_StcpnQuery, GetProfile_StcpnQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProfile_StcpnQuery, GetProfile_StcpnQueryVariables>(GetProfile_StcpnDocument, options);
        }
export type GetProfile_StcpnQueryHookResult = ReturnType<typeof useGetProfile_StcpnQuery>;
export type GetProfile_StcpnLazyQueryHookResult = ReturnType<typeof useGetProfile_StcpnLazyQuery>;
export type GetProfile_StcpnQueryResult = Apollo.QueryResult<GetProfile_StcpnQuery, GetProfile_StcpnQueryVariables>;
...
export const SubscribeToColonyPushNotificationsDocument = gql`
    mutation SubscribeToColonyPushNotifications($input: SubscribeColonyPushNotificationInput!) {
  subscribeToColonyPushNotifications(input: $input)
}
    `;
export type SubscribeToColonyPushNotificationsMutationFn = Apollo.MutationFunction<SubscribeToColonyPushNotificationsMutation, SubscribeToColonyPushNotificationsMutationVariables>;

/**
 * __useSubscribeToColonyPushNotificationsMutation__
 *
 * To run a mutation, you first call `useSubscribeToColonyPushNotificationsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubscribeToColonyPushNotificationsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [subscribeToColonyPushNotificationsMutation, { data, loading, error }] = useSubscribeToColonyPushNotificationsMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSubscribeToColonyPushNotificationsMutation(baseOptions?: Apollo.MutationHookOptions<SubscribeToColonyPushNotificationsMutation, SubscribeToColonyPushNotificationsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SubscribeToColonyPushNotificationsMutation, SubscribeToColonyPushNotificationsMutationVariables>(SubscribeToColonyPushNotificationsDocument, options);
      }
export type SubscribeToColonyPushNotificationsMutationHookResult = ReturnType<typeof useSubscribeToColonyPushNotificationsMutation>;
export type SubscribeToColonyPushNotificationsMutationResult = Apollo.MutationResult<SubscribeToColonyPushNotificationsMutation>;
export type SubscribeToColonyPushNotificationsMutationOptions = Apollo.BaseMutationOptions<SubscribeToColonyPushNotificationsMutation, SubscribeToColonyPushNotificationsMutationVariables>;
export const UpdateUserNotificationTokenDocument = gql`
    mutation UpdateUserNotificationToken($id: ID!, $notificationTokens: [String]!) {
  updateProfile(
    input: {id: $id, notificationSettings: {notificationTokens: $notificationTokens}}
  ) {
    id
    notificationSettings {
      notificationTokens
    ...
    `;
export type UpdateUserNotificationTokenMutationFn = Apollo.MutationFunction<UpdateUserNotificationTokenMutation, UpdateUserNotificationTokenMutationVariables>;

/**
 * __useUpdateUserNotificationTokenMutation__
 *
 * To run a mutation, you first call `useUpdateUserNotificationTokenMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateUserNotificationTokenMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateUserNotificationTokenMutation, { data, loading, error }] = useUpdateUserNotificationTokenMutation({
 *   variables: {
 *      id: // value for 'id'
 *      notificationTokens: // value for 'notificationTokens'
 *   },
 * });
 */
export function useUpdateUserNotificationTokenMutation(baseOptions?: Apollo.MutationHookOptions<UpdateUserNotificationTokenMutation, UpdateUserNotificationTokenMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateUserNotificationTokenMutation, UpdateUserNotificationTokenMutationVariables>(UpdateUserNotificationTokenDocument, options);
      }
export type UpdateUserNotificationTokenMutationHookResult = ReturnType<typeof useUpdateUserNotificationTokenMutation>;
export type UpdateUserNotificationTokenMutationResult = Apollo.MutationResult<UpdateUserNotificationTokenMutation>;
export type UpdateUserNotificationTokenMutationOptions = Apollo.BaseMutationOptions<UpdateUserNotificationTokenMutation, UpdateUserNotificationTokenMutationVariables>;
