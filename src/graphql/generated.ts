...
export const ExpenditureFragmentDoc = gql`
  ...
  cancellingActions: actions(
    filter: {or: [{type: {eq: CANCEL_EXPENDITURE}}, {type: {eq: CANCEL_EXPENDITURE_MOTION}}], isMotionFinalization: {ne: true}}
  ) {
    items {
      ...ExpenditureAction
    }
