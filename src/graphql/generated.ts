...
export type GetStreamingPaymentQuery = { __typename?: 'Query', getStreamingPayment?: { __typename?: 'StreamingPayment', id: string, nativeId: number, recipientAddress: string, creatorAddress: string, nativeDomainId: number, startTime: string, endTime: string, interval: string, tokenAddress: string, amount: string, isCancelled?: boolean | null, isWaived?: boolean | null, createdAt: string, token?: { __typename?: 'Token', decimals: number, name: string, symbol: string, type?: TokenType | null, avatar?: string | null, thumbnail?: string | null, tokenAddress: string } | null, metadata?: { __typename?: 'StreamingPaymentMetadata', endCondition: StreamingPaymentEndCondition, changelog?: Array<{ __typename?: 'StreamingPaymentMetadataChangelog', transactionHash: string, oldEndCondition: StreamingPaymentEndCondition, newEndCondition: StreamingPaymentEndCondition }> | null } | null, claims?: Array<{ __typename?: 'StreamingPaymentClaim', amount: string, timestamp: string }> | null } | null };
...
export type SearchStreamingPaymentsQueryVariables = Exact<{
  nextToken?: InputMaybe<Scalars['String']>;
  limit?: InputMaybe<Scalars['Int']>;
...
export type GetStreamingPaymentsByColonyQuery = { __typename?: 'Query', getStreamingPaymentsByColony?: { __typename?: 'ModelStreamingPaymentConnection', nextToken?: string | null, items: Array<{ __typename?: 'StreamingPayment', id: string, nativeId: number, recipientAddress: string, creatorAddress: string, nativeDomainId: number, startTime: string, endTime: string, interval: string, tokenAddress: string, amount: string, isCancelled?: boolean | null, isWaived?: boolean | null, createdAt: string, token?: { __typename?: 'Token', decimals: number, name: string, symbol: string, type?: TokenType | null, avatar?: string | null, thumbnail?: string | null, tokenAddress: string } | null, metadata?: { __typename?: 'StreamingPaymentMetadata', endCondition: StreamingPaymentEndCondition, changelog?: Array<{ __typename?: 'StreamingPaymentMetadataChangelog', transactionHash: string, oldEndCondition: StreamingPaymentEndCondition, newEndCondition: StreamingPaymentEndCondition }> | null } | null, claims?: Array<{ __typename?: 'StreamingPaymentClaim', amount: string, timestamp: string }> | null } | null> } | null };
...
export const SearchStreamingPaymentsDocument = gql`
  ...
  searchStreamingPayments(
    ...
    items {
      actions(
        filter: {type: {eq: CREATE_STREAMING_PAYMENT}, isMotionFinalization: {ne: true}}
      ) {
        items {
          ...ExpenditureAction
        }
...
/**
 * __useSearchStreamingPaymentsQuery__
 *
 * To run a query within a React component, call `useSearchStreamingPaymentsQuery` and pass it any options that fit your needs.
 * When your component renders, `useSearchStreamingPaymentsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSearchStreamingPaymentsQuery({
 *   variables: {
 *      nextToken: // value for 'nextToken'
 *      limit: // value for 'limit'
 *      sort: // value for 'sort'
...
export function useSearchStreamingPaymentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchStreamingPaymentsQuery, SearchStreamingPaymentsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SearchStreamingPaymentsQuery, SearchStreamingPaymentsQueryVariables>(SearchStreamingPaymentsDocument, options);
        }
export type SearchStreamingPaymentsQueryHookResult = ReturnType<typeof useSearchStreamingPaymentsQuery>;
export type SearchStreamingPaymentsLazyQueryHookResult = ReturnType<typeof useSearchStreamingPaymentsLazyQuery>;
export type SearchStreamingPaymentsQueryResult = Apollo.QueryResult<SearchStreamingPaymentsQuery, SearchStreamingPaymentsQueryVariables>;
