...
import { ColonyAndExtensionsEvents } from '~types/actions';
...
const eventsMessageDescriptors = {
  'event.title': `{eventName, select,
      ...
      ${ColonyAndExtensionsEvents.ColonyFundsMovedBetweenFundingPots} {{initiator} transferred {amount} {tokenSymbol} from {fromDomain} to {toDomain}}
      ...
      ${ColonyAndExtensionsEvents.ColonyMetadata} {{initiator} changed this colony's {colonyMetadataChanges}}
