...
export const sidebarButtonClass = tw`flex min-h-[38px] w-full items-center !justify-start !gap-3 rounded-lg !border-none bg-base-white !px-3 !py-1 hover:bg-gray-100 md:bg-gray-900 md:!px-2 md:hover:bg-gray-800`;
