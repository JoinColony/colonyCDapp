...
import { type FinalizeWithStakingInfoProps } from './types.ts';

const displayName =
  'v5.common.CompletedAction.partials.PaymentBuilder.partials.FinalizeWithStakingInfo';
...
const FinalizeWithStakingInfo: FC<FinalizeWithStakingInfoProps> = ({
  userAdddress,
  stakeAmount,
}) => {
...
export default FinalizeWithStakingInfo;
