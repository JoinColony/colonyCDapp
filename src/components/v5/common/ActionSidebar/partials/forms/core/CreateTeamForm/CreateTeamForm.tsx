...
const displayName = 'v5.common.ActionSidebar.CreateNewTeamForm';

const CreateTeamForm: FC<CreateActionFormProps> = ({ getFormOptions }) => {
...
CreateTeamForm.displayName = displayName;
