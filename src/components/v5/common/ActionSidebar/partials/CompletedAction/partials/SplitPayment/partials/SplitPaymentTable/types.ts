...
import { type AmountFieldProps } from '~v5/common/ActionSidebar/partials/CompletedAction/partials/PaymentBuilder/partials/PaymentBuilderTable/partials/AmountField/types.ts';
