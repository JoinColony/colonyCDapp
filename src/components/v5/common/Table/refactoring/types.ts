...
export interface PaginationOptions {
  ...
  previousPage?: VoidFunction; // Go to previous page
  nextPage?: VoidFunction; // Go to next page
...
export interface BaseTableOptions<T>
  ...
  columnSizeUnit?: 'px' | 'rem' | 'em' | '%'; // Column sizing
  borders?: {
...
export type BaseTableLayoutProps<T> = Pick<
  BaseTableProps<T>,
  'table' | 'layout' | 'moreActions' | 'columnSizeUnit' | 'borders' | 'rows'
> &
  PropsWithChildren;
