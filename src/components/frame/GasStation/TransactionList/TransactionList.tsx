...
import { TransactionOrMessageGroup, TransactionOrMessageGroups, getGroupId, isTxGroup } from '../transactionGroup';
...
const TransactionList = ({ onClickGroup, transactionAndMessageGroups }: Props) => (
  <CardList appearance={{ numCols: '1' }} data-test="gasStationTransactionsList">
    {transactionAndMessageGroups.map((transactionOrMessageGroup: TransactionOrMessageGroup, idx: number) =>
