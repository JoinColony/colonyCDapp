...
import { type AgreementsPageFiltersItemProps } from './types.ts';

const AgreementsPageFiltersItem: FC<AgreementsPageFiltersItemProps> = ({
  icon: Icon,
  label,
  children,
}) => {
...
export default AgreementsPageFiltersItem;
