  ...
  return useMemo(() => {
    ...
    return [
      helper.display({
        ...
        cell: ({ row }) => (
          <TitleField
            ...
            amount={row.original.streamed}
            initiator={row.original.initiator}
      ...
      helper.display({
        ...
        enableSorting: true,
        cell: ({ row }) => (
          <p className="text-md text-gray-600">{row.original.token.symbol}</p>
        ),
        colSpan: (isExpanded) => (isExpanded ? 0 : undefined),
      ...
      helper.display({
        ...
        staticSize: '8.125rem',
        enableSorting: false,
        cell: ({ row }) => <TeamField teamId={row.original.team} />,
