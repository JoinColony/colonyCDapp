...
const StreamingActionsTable: FC<StreamingActionsTableProps> = ({
  ...
  return (
    <Table<StreamingActionTableFieldModel>
      ...
      columns={columns}
      className={clsx(
        '[&_td:first-child]:!pl-0 [&_td]:border-b [&_td]:border-gray-100 [&_td]:!pr-0 [&_th:not(:first-child)]:sm:text-center [&_th]:!rounded-none [&_tr.expanded-below_td]:border-none [&_tr:last-child_td]:border-none',
        {
