...
const StreamingPaymentsTable = () => {
  ...
  return (
    <Table<StreamingTableFieldModel>
      className="[&_table]:table-auto [&_table]:overflow-hidden lg:[&_table]:table-fixed [&_tbody_td]:h-[57px] [&_td:first-child]:pl-0 [&_td:last-child]:pr-0 [&_td]:border-gray-100 [&_td]:pr-0 [&_th]:border-none [&_tr.expanded-below+tr_td]:pl-0 [&_tr.expanded-below+tr_td]:pr-0 [&_tr.expanded-below>td]:border-gray-200 [&_tr.expanded-below_td]:h-[57px] [&_tr:hover_.toggler]:text-blue-400 [&_tr:not(.expanded-content):hover_td]:bg-gray-25 [&_tr:not(:last-child)_td]:border-b"
