...
import { extensionSettingsParamsScheme } from './partials/ExtensionTabs/consts.ts';
...
export const getExtensionDataParams = (extensionData: AnyExtensionData) => {
  const params = (extensionData as InstalledExtensionData).params?.[
    extensionSettingsParamsScheme[extensionData.extensionId]
  ];
