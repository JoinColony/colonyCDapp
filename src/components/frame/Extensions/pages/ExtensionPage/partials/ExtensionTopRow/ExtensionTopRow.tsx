...
const displayName = 'pages.ExtensionPage.ExtensionTopRow';
...
const ExtensionsTopRow: FC<ExtensionsTopRowProps> = ({
  ...
  return (
    <>
      ...
      <div className="flex flex-col flex-wrap justify-between sm:min-h-[2.5rem] sm:flex-row sm:items-center sm:gap-6 ">
