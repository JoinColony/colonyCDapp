...
const displayName = 'pages.ExtensionPage.DeprecateButton';
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={formatText({ id: 'extensionPage.deprecate' })}
        subTitle={formatText({
          id: 'extensionPage.deprecateDescription',
        })}
      ...
      >
        <p className="mt-6 text-md text-gray-600">
          {formatText({ id: 'extensionPage.confirmation' })}
        </p>
      </Modal>
    </>
  );
