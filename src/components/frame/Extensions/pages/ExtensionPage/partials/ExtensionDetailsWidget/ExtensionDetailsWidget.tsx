...
import DeprecateButton from './partials/DeprecateButton.tsx';
import UninstallButton from './partials/UninstallButton/UninstallButton.tsx';
import { type ExtensionDetailsProps } from './types.ts';

const displayName =
  'frame.Extensions.pages.ExtensionPage.partials.ExtensionDetailsWidget';
