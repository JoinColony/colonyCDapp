...
import { waitForDbAfterExtensionAction } from '../ExtensionDetailsPageContent/utils.tsx';
...
const displayName =
  'frame.Extensions.pages.ExtensionDetailsPage.partials.InstallButton';
...
const InstallButton = ({
  ...
  const isAutomaticallyEnabledExtension =
  ...
  useEffect(() => {
    ...
    if (
      ...
      isAutomaticallyEnabledExtension &&
