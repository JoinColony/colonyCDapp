...
export const mockedExtensionSettings = [
  {
    ...
    description: 'Percentage of the team’s reputation, in token terms, should need to stake on each side of a motion',
  },
  {
    complementaryLabel: 'percent',
    title: 'Voter Reward',
    description: 'In a dispute, the percentage of the losing side’s stake should be awarded to the voters',
  },
  {
    complementaryLabel: 'percent',
    title: 'Minimum Stake',
    description: 'Minimum percentage of the total stake that each staker should have to provide',
  },
  {
    complementaryLabel: 'percent',
    title: 'End Vote Threshold',
    description: 'Threshold of reputation having voted should the voting period to end',
  },
  {
  ...
  },
  {
    ...
    description: 'How long allowed for members to escalate a dispute to a higher team',
  },
];
