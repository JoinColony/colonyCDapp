...
export const mapTheme = (variables: ITheme): IMappedTheme => {
  return {
    ...
    '--color-teams-yellow-200': variables.teamsYellow200 || '',
    ...
    '--color-teams-red-200': variables.teamsRed200 || '',
    ...
    '--color-teams-green-300': variables.teamsGreen300 || '',
    ...
    '--color-teams-blue-500': variables.teamsBlue500 || '',
