  ...
  return (
    <div className="flex bg-base-white relative">
      ...
      <div className="flex flex-col ml-[1.140625rem]">
        {title && <span className="text-md text-gray-900 font-semibold pb-1">{titleText}</span>}
        {description && <span className="text-md text-gray-600 font-normal pb-1">{descriptionText}</span>}
        {linkName && (
          <Link
            to={url}
