...
const IndexModal = ({ title, cancel, items, back }: Props) => {
   ...
   */
  const [autogeneratedIds] = useState<string[]>([...new Array(items.length)].map(nanoid));
  return (
    <Dialog cancel={cancel}>
      ...
      <div className={styles.content}>
        ...
        {back && (
          <Button appearance={{ theme: 'secondary' }} onClick={back} className={styles.backButton}>
            <Icon appearance={{ size: 'normal' }} name="caret-left" title={{ id: 'button.back' }} />
