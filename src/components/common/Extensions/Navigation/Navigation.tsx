...
const Navigation: FC = () => {
  ...
  const navigationItems = [
    {
      id: 0,
      linkTo: `https://colony/${name}`,
      label: 'Colony Details',
      value: 'colony-details',
    },
    {
      id: 1,
      linkTo: `https://colony/${name}/reputation`,
      label: 'Reputation',
      value: 'reputation',
    },
    {
      id: 2,
      linkTo: `https://colony/${name}/permissions`,
      label: 'Permissions',
      value: 'permissions',
    },
    {
      id: 3,
      linkTo: `https://colony/${name}/extensions`,
      label: 'Extensions',
      value: 'extensions',
    },
    {
      id: 4,
      linkTo: `https://colony/${name}/integrations`,
      label: 'Integrations',
      value: 'integrations',
    },
    {
      id: 5,
      linkTo: `https://colony/${name}/incorporation`,
      label: 'Incorporation',
      value: 'incorporation',
    },
    {
      id: 6,
      linkTo: `https://colony/${name}/advanced`,
      label: 'Advanced',
      value: 'advanced',
    },
  ];
