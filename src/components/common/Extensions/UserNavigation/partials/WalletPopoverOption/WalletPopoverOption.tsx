...
const displayName =
  'common.Extensions.UserNavigation.partials.WalletPopoverOption';

const WalletPopoverOption: FC<WalletPopoverOptionProps> = ({
  description,
  icon,
  title,
  onClick,
  ...
  return (
    <button
      ...
      className={styles.walletPopoverOption}
      onClick={onClick}
    >
      <div className="flex items-center">
        <Icon name={icon} appearance={{ size: 'large' }} />
        <div className="ml-4 flex flex-col justify-start">
          <h5 className="heading-5 text-left">{formatMessage(title)}</h5>
