...
interface ExpenditureStagesFieldProps {
  colony: Colony;
}

const ExpenditureStagesField = ({ colony }: ExpenditureStagesFieldProps) => {
  ...
  return (
    <div>
      ...
      <IconButton
        onClick={() => append(getInitialStageFieldValue())}
        text=""
        icon="circle-plus"
      />
    </div>
...
export default ExpenditureStagesField;
