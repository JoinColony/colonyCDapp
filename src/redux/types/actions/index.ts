 ...
 * M: any additional `meta` properties, e.g. `key: *`
 */
export interface ActionTypeWithPayloadAndMeta<T extends string, P, M extends Record<string, unknown>>
 ...
 */
export interface ErrorActionType<T extends string, M> extends ActionTypeWithPayloadAndMeta<T, Error, M> {
  error: true;
}
