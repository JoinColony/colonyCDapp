export enum ActionTypes {
  ...
  FINISH_CREATE_ERROR = 'FINISH_CREATE_ERROR',
  FINISH_CREATE_SUCCESS = 'FINISH_CREATE_SUCCESS',
  ...
  MOTION_STREAMING_PAYMENTS_CANCEL = 'MOTION_STREAMING_PAYMENTS_CANCEL',
  MOTION_STREAMING_PAYMENTS_CANCEL_SUCCESS = 'MOTION_STREAMING_PAYMENTS_CANCEL_SUCCESS',
  MOTION_STREAMING_PAYMENTS_CANCEL_ERROR = 'MOTION_STREAMING_PAYMENTS_CANCEL_ERROR',
  MOTION_STREAMING_PAYMENT_CANCEL = 'MOTION_STREAMING_PAYMENT_CANCEL',
  MOTION_STREAMING_PAYMENT_CANCEL_SUCCESS = 'MOTION_STREAMING_PAYMENT_CANCEL_SUCCESS',
  MOTION_STREAMING_PAYMENT_CANCEL_ERROR = 'MOTION_STREAMING_PAYMENT_CANCEL_ERROR',
  MOTION_STREAMING_PAYMENT_EDIT = 'MOTION_STREAMING_PAYMENT_EDIT',
  MOTION_STREAMING_PAYMENT_EDIT_SUCCESS = 'MOTION_STREAMING_PAYMENT_EDIT_SUCCESS',
  MOTION_STREAMING_PAYMENT_EDIT_ERROR = 'MOTION_STREAMING_PAYMENT_EDIT_ERROR',
  MOTION_STREAMING_PAYMENT_CREATE = 'MOTION_STREAMING_PAYMENT_CREATE',
  MOTION_STREAMING_PAYMENT_CREATE_SUCCESS = 'MOTION_STREAMING_PAYMENT_CREATE_SUCCESS',
  MOTION_STREAMING_PAYMENT_CREATE_ERROR = 'MOTION_STREAMING_PAYMENT_CREATE_ERROR',
  ...
  MULTISIG_EXPENDITURE_FUND = 'MULTISIG_EXPENDITURE_FUND',
  MULTISIG_EXPENDITURE_FUND_ERROR = 'MULTISIG_EXPENDITURE_FUND_ERROR',
  MULTISIG_EXPENDITURE_FUND_SUCCESS = 'MULTISIG_EXPENDITURE_FUND_SUCCESS',
  /*
   * Decision Draft
   */
  ...
  TRANSACTION_UPDATED_IN_DB = 'TRANSACTION_UPDATED_IN_DB',
  /*
   * Wallet
   */
  ...
  STREAMING_PAYMENT_CLAIM = 'STREAMING_PAYMENT_CLAIM',
  STREAMING_PAYMENT_CLAIM_SUCCESS = 'STREAMING_PAYMENT_CLAIM_SUCCESS',
  STREAMING_PAYMENT_CLAIM_ERROR = 'STREAMING_PAYMENT_CLAIM_ERROR',
  STREAMING_PAYMENT_EDIT = 'STREAMING_PAYMENT_EDIT',
  STREAMING_PAYMENT_EDIT_SUCCESS = 'STREAMING_PAYMENT_EDIT_SUCCESS',
  STREAMING_PAYMENT_EDIT_ERROR = 'STREAMING_PAYMENT_EDIT_ERROR',
<<<<<<< HEAD
  /*
   * Transactions
   */
  CREATE_ARBITRARY_TRANSACTION = 'CREATE_ARBITRARY_TRANSACTION',
  CREATE_ARBITRARY_TRANSACTION_SUCCESS = 'CREATE_ARBITRARY_TRANSACTION_SUCCESS',
  CREATE_ARBITRARY_TRANSACTION_ERROR = 'CREATE_ARBITRARY_TRANSACTION_ERROR',
=======
>>>>>>> 238a0f552 (Feat: Edit streams using permissions)
}
