export enum ActionTypes {
  ...
  MOTION_EXPENDITURE_CREATE = 'MOTION_EXPENDITURE_CREATE',
  MOTION_EXPENDITURE_CREATE_ERROR = 'MOTION_EXPENDITURE_CREATE_ERROR',
  MOTION_EXPENDITURE_CREATE_SUCCESS = 'MOTION_EXPENDITURE_CREATE_SUCCESS',
