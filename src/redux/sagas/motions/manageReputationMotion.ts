...
import { ClientType, getChildIndex, getPermissionProofs, ColonyRole, Id } from '@colony/colony-js';
import { AddressZero } from '@ethersproject/constants';

import { ActionTypes } from '../../actionTypes';
import { AllActions, Action } from '../../types/actions';
import { putError, takeFrom, updateDomainReputation, getColonyManager } from '../utils';

import { createTransaction, createTransactionChannels, getTxChannel } from '../transactions';
import { transactionReady } from '../../actionCreators';

export type ManageReputationMotionPayload = Action<ActionTypes.MOTION_MANAGE_REPUTATION>['payload'];
