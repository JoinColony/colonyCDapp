const { DEFAULT_NETWORK } = require('./queries');
...
const DEFAULT_NETWORK_TOKEN = TOKEN_DATA[DEFAULT_NETWORK];
...
const currencyApiConfig = {
    endpoints: {
        ...
        tokenPriceByAddress: {
            url: `${COINGECKO_API_URL}/api/v3/simple/token_price`,
            searchParams: {
        ...
        // tokenPriceByName: {
        //   url: `${COINGECKO_API_URL}/api/v3/simple/price`,
        //   searchParams: {
        //     from: 'ids',
        //     to: 'vs_currencies',
        //     api: 'x_cg_demo_api_key',
